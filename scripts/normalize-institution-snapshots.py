...
# or evidence sections that should not become role rows. Existing receipts keep
# their historical behavior except MTW, whose old receipt already excluded H3s.
CONFIG = [
    ...
    ("covenant-college", "sources/raw/institutions/covenant-college/leadership-snapshot-2026-09-03.md", "2026-09-03", "https://www.covenant.edu/about/who/leadership/index.html", ["Current president"], True, "president only; senior administration and trustees remain blocked"),
    ...
    ("mission-to-north-america", "sources/raw/institutions/mna/team-snapshot-2026-09-03.md", "2026-09-03", "https://www.pcamna.org/about", ["Current leadership visible on the team page", "High-signal current ministries and personnel"], True, "high-signal partial roster; large regional Disaster Response and Metanoia teams remain incomplete"),
    ...
    ("westminster-theological-seminary", "sources/raw/institutions/westminster-theological-seminary/faculty-snapshot-2026-09-03.md", "2026-09-03", "https://www.wts.edu/academic-study/faculty", ["Current faculty names exposed by the official faculty/media index"], True, "current names; exact titles and individual bios remain incomplete"),
]
